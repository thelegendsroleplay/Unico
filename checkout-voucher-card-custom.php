            ...
            <div style="display: flex; align-items: flex-start; gap: 12px;">
                ...
                <div style="flex-grow: 1;">
                    ...
                    <p style="color: #383d41; margin: 0; font-size: 14px; line-height: 1.5; margin-bottom: 10px;">
                        We'll send a verification code to <strong><?php echo esc_html($buyer_email); ?></strong>. Complete payment after verification.
                    </p>
    ...
    <div class="unico-checkout-card"
        ...
        <div class="unico-checkout-row">
            <div class="unico-field">
                ...
                <input type="text" name="voucher_buyer_full_name" value="<?php echo esc_attr($buyer_name); ?>" required>
            </div>
            <div class="unico-field">
                <label>Registered Email ID</label>
                <input type="email" name="voucher_buyer_email" value="<?php echo esc_attr($buyer_email); ?>" required>
            </div>
        </div>
            ...
            <?php else: ?>
                <div class="unico-bank-card" style="background: #fff3cd; border-color: #ffc107;">
                    <div class="unico-bank-notice">
                        ...
                        <div>
                            <strong>Notice:</strong> No bank accounts are currently configured. Please contact support.
                        </div>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <div class="unico-field">
            ...
            <input type="text" name="voucher_payment_reference" placeholder="Transaction ID..." required>
        </div>
    ...
    jQuery(document).ready(function($) {
        ...
        function updateCart(qty) {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    action: 'unico_update_cart_quantity_custom',
        ...
        $('#unico-receipt-upload').on('change', function() {
            ...
            if (file) {
                ...
                formData.append('voucher_payment_receipt', file);
                formData.append('action', 'unico_upload_payment_receipt');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            alert('Failed to upload receipt: ' + response.data.message);
                            $('#unico-receipt-upload').val('');
                        }
                    },
                    error: function() {
