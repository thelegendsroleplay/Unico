                ...
                <div class="application-alert application-alert-success">
                    ...
                    <div class="application-alert-body">
                        ...
                        <p style="margin-top: 12px;">
                            Your agent application has been saved and sent to our management team for review.
                            You will receive an email with the approval decision within 24-48 hours.
                        </p>
                        <p style="margin-top: 12px; font-size: 14px; color: #666;">
                            <strong>Next Steps:</strong> If approved, you will receive login credentials via email to access your agent account.
                        </p>
                    </div>
                </div>
            <?php else: ?>
