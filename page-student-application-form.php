        ...
        <div class="application-main">
            ...
            <?php else: ?>
                ...
                <form method="post" action="" class="application-form">
                    ...
                    $pre_filled_email = isset($_GET['email']) ? urldecode($_GET['email']) : '';
                    $is_verified = !empty($pre_filled_email) && $application_form->is_notification_recipient(0, $pre_filled_email); // We'll use a public method
                    ?>
                        ...
                        <div id="email-verification-form" style="display: block;">
                            ...
                            <div style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                                <input
                                    ...
                                    value="<?php echo esc_attr($pre_filled_email); ?>"
                                    required
